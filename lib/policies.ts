...
export interface PolicyRepository {
  ...
  update(id: string, input: UpdatePolicyRecordInput): Promise<PolicyRecord | null>
}
...
export function computePolicyStatus(policy: PolicyRecord): DashboardPolicyStatus {
...
class LocalStoragePolicyRepository implements PolicyRepository {
  ...
  async update(id: string, input: UpdatePolicyRecordInput): Promise<PolicyRecord | null> {
    const records = safeReadAll()
