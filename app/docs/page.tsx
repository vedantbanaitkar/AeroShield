  ...
  return (
    <div className="relative group glass rounded-xl overflow-hidden my-4">
      <div className="flex items-center justify-between px-4 py-2 border-b border-white/5">
        ...
        <button
          onClick={copy}
          className="flex items-center gap-1.5 text-xs text-slate-600 hover:text-slate-800 transition-colors opacity-0 group-hover:opacity-100"
        >
          {copied ? (
      ...
      <pre className="p-4 overflow-x-auto text-xs leading-relaxed text-slate-800 font-mono">
        {code}
      </pre>
    </div>
  );
...
function SectionHeader({
  ...
  return (
    <div id={id} className="flex items-center gap-3 mb-6 pt-2">
      ...
      {badge && (
        <Badge className="bg-cyan-400/10 text-cyan-400 border-cyan-400/20 text-xs">
          {badge}
        </Badge>
      )}
    </div>
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <aside className="md:col-span-1">
            <motion.div {...fadeUp()} className="sticky top-24">
              <p className="text-xs uppercase tracking-widest text-slate-700 font-semibold mb-3 px-3">
                Documentation
              </p>
          ...
          <main className="md:col-span-3 space-y-16">
            ...
            <motion.section {...fadeUp(0.1)}>
              ...
              <p className="text-slate-700 leading-relaxed mb-4">
                AeroShield is a parametric insurance protocol built on the
                Algorand blockchain. Unlike traditional insurance, parametric
                insurance removes the claims process entirely — payout is
                automatic the moment a predefined data condition is met.
              </p>
              <p className="text-slate-700 leading-relaxed mb-6">
                The MVP focuses on flight delay insurance, where an oracle
                monitors real-time flight data and triggers an atomic inner
                transaction to pay the policyholder when a departure delay
                ...
                {[
                  {
                    ...
                    value: "Algorand TypeScript",
                    color: "cyan",
                  },
                  {
                    label: "Oracle",
                    value: "AviationStack API",
                    color: "violet",
                  },
                  {
                    label: "Network",
            ...
            <motion.section {...fadeUp(0.15)}>
              ...
              <p className="text-zinc-400 leading-relaxed mb-4">
                AeroShield consists of three components: a Next.js frontend, an
                oracle API route, and an Algorand smart contract.
              </p>
            ...
            <motion.section {...fadeUp(0.2)}>
              <SectionHeader
                ...
                badge="Algorand TypeScript"
              />
              <p className="text-slate-700 leading-relaxed mb-4">
                The contract exposes two ABI methods:{" "}
  ...
  triggerPayout(
    ...
    log(concat('PAYOUT:', flightNumber))
            ...
            <motion.section {...fadeUp(0.25)}>
              ...
              <p className="text-slate-700 leading-relaxed mb-4">
                The oracle is a Next.js API route that acts as a trusted bridge
                between AviationStack's REST API and the Algorand smart
                contract. In production, this will be replaced by Goracle
                Network nodes for trustless decentralization.
              </p>
              <CodeBlock
                language="typescript"
                code={`// app/api/oracle/route.ts
                    ...
                    params: [
                      {
                        name: "flight",
                        type: "string",
                        desc: "IATA flight code (e.g. AI302)",
                      },
                      {
                        name: "mock",
                        type: "boolean",
                        desc: "Return simulated 150min delay for demo",
                      },
                    ],
                    color: "emerald",
                  },
                    ...
                    params: [
                      {
                        name: "beneficiary",
                        type: "string",
                        desc: "Algorand address to receive payout",
                      },
                      {
                        name: "coverageAmountAlgo",
                        type: "number",
                        desc: "Coverage in ALGO",
                      },
                      {
                        name: "flightNumber",
                        type: "string",
                        desc: "IATA flight code",
                      },
                      {
                        name: "appId",
                        type: "number",
                        desc: "Deployed contract App ID",
                      },
                    ],
                    color: "cyan",
                  },
                      ...
                      <table className="w-full text-xs">
                        <thead>
                          <tr className="text-left">
                            <th className="text-slate-700 pb-2 font-medium">
                              Parameter
                            </th>
                            <th className="text-slate-700 pb-2 font-medium">
                              Type
                        ...
                        <tbody className="divide-y divide-white/5">
                          {endpoint.params.map((param) => (
                            <tr key={param.name}>
                              ...
                              <td className="py-2 pr-4 text-violet-400">
                                {param.type}
                              </td>
                ...
                {[
                  {
                    ...
                    code: "git clone https://github.com/team-chain-reaction/aeroshield\ncd aeroshield && npm install",
                  },
                  {
                    step: "2",
