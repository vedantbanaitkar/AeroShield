...
import {
  ...
  Zap, ArrowRight, CheckCircle2, Lock, Globe
} from 'lucide-react'
              ...
              <div className="relative p-6 sm:p-8">
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="flex items-start gap-4 mb-5">
                      ...
                      <div>
                        <div className="flex items-center gap-3 mb-1">
                          ...
                          <Badge variant="outline" className="text-zinc-600 border-zinc-700 text-xs">{product.category}</Badge>
                          {product.status === 'live' ? (
                            <Badge className="bg-emerald-400/10 text-emerald-400 border-emerald-400/20 text-xs">
                              Live on Testnet
                            </Badge>
                          ) : (
                            <Badge className="bg-zinc-800 text-zinc-500 border-zinc-700 text-xs">Coming Soon</Badge>
                          )}
                        </div>
                  ...
                  <div className="glass rounded-xl p-5 space-y-3 self-start">
                    <p className="text-xs uppercase tracking-widest text-zinc-600 mb-3">Policy specs</p>
                    {[
                    ...
                    {product.status === 'live' ? (
                      ...
                      <Button size="sm" variant="outline" className="w-full mt-4 border-white/10 text-zinc-500 gap-2" disabled>
                        Notify me when live
